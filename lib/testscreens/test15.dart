...
class Test15 extends StatefulWidget{
  const Test15({super.key});

  @override
  State<Test15> createState() {
    return _Test15();
  }
}

class _Test15 extends State<Test15>{

  List<int> list15 = List.filled(5, 0);
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Text(
                    '1. Provision of an accessible water tap/spout(easily manoeuvred drinking facility by a person with poor hand function/wheelchair user)',
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Text(
                    '2. Provision of a dry and hygienic drinking water area with adequate drainage',
                    style: TextStyle(fontSize: 16),
                  ),
                ),
            ...
            child: Column(
              children: [
                Container(
                  padding: EdgeInsets.all(16),
                  child: const Text(
                    '3. Provision grating as per design suggested in Harmonised Guidelines, 2021',
                    style: TextStyle(fontSize: 16),
                  ),
                ),
            ...
            child: Column(
              children: [
                Container(
                  padding: EdgeInsets.all(16),
                  child: const Text(
                    '4. Provision of glasses/ water filling stations at accessible height',
                    style: TextStyle(fontSize: 16),
                  ),
                ),
            ...
            child: Column(
              children: [
                Container(
                  padding: EdgeInsets.all(16),
                  child: const Text(
                    '5. Provision of drinking water facility as per dimensions specified section 4.8 of Harmonised Guidelines,2021',
                    style: TextStyle(fontSize: 16),
                  ),
                ),
