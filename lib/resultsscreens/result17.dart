...
class Result17 extends StatefulWidget{
  Result17({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result17> createState() {
    return _Result17();
  }
}

class _Result17 extends State<Result17>{
