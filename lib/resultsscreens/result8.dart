...
class Result8 extends StatefulWidget{
  Result8({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result8> createState() {
    return _Result8();
  }
}

class _Result8 extends State<Result8>{
