...
class Result20 extends StatefulWidget{
  Result20({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result20> createState() {
    return _Result20();
  }
}

class _Result20 extends State<Result20>{
  ...
  late var finalmarks = 2*widget.MarksObtained;
