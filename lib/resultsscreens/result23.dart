...
class Result23 extends StatefulWidget{
  Result23({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result23> createState() {
    return _Result23();
  }
}

class _Result23 extends State<Result23>{
