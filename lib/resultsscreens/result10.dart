...
class Result10 extends StatefulWidget{
  Result10({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result10> createState() {
    return _Result10();
  }
}

class _Result10 extends State<Result10>{
