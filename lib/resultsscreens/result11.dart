...
class Result11 extends StatefulWidget{
  Result11({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result11> createState() {
    return _Result11();
  }
}

class _Result11 extends State<Result11>{
