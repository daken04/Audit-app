...
class Result22 extends StatefulWidget{
  Result22({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result22> createState() {
    return _Result22();
  }
}

class _Result22 extends State<Result22>{
  ...
  late var finalmarks = 4*widget.MarksObtained;
  ...
  Widget build(BuildContext context) {
    if(_ApplicableParameters==-1)
    {
      return Scaffold(
        appBar: AppBar(
          title: const Text("Other Provisions"),
        ),
