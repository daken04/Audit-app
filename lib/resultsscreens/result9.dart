...
class Result9 extends StatefulWidget{
  Result9({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result9> createState() {
    return _Result9();
  }
}

class _Result9 extends State<Result9>{
