...
class Result16 extends StatefulWidget{
  Result16({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result16> createState() {
    return _Result16();
  }
}

class _Result16 extends State<Result16>{
