...
class Result19 extends StatefulWidget{
  Result19({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result19> createState() {
    return _Result19();
  }
}

class _Result19 extends State<Result19>{
  ...
  Widget build(BuildContext context) {
    if(_ApplicableParameters==-1)
    {
      return Scaffold(
        appBar: AppBar(
          title: const Text("Emergency Exits"),
        ),
