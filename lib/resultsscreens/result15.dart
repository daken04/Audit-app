...
class Result15 extends StatefulWidget{
  Result15({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result15> createState() {
    return _Result15();
  }
}

class _Result15 extends State<Result15>{
