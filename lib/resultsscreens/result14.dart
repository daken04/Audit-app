...
class Result14 extends StatefulWidget{
  Result14({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result14> createState() {
    return _Result14();
  }
}

class _Result14 extends State<Result14>{
  ...
  Widget build(BuildContext context) {
    if(_ApplicableParameters==-1)
    {
      return Scaffold(
        appBar: AppBar(
          title: const Text("Sanitary Provisions"),
        ),
