...
class Result5 extends StatefulWidget{
  Result5({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
