...
class Result18 extends StatefulWidget{
  Result18({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result18> createState() {
    return _Result18();
  }
}

class _Result18 extends State<Result18>{
