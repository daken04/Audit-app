...
class Result13 extends StatefulWidget{
  Result13({super.key,required this.ApplicableParameters,required this.ApplicableTotalMarks,required this.MarksObtained});
  ...
  @override
  State<Result13> createState() {
    return _Result13();
  }
}

class _Result13 extends State<Result13>{
